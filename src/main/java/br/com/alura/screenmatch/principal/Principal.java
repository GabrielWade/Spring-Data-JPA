...
public class Principal {
    ...
    private void buscarSeriePorAtor() {
        ...
        System.out.println("Series em que o ator " + nomeAtor + " participa:");
        seriesEncontradas.forEach(s -> System.out.println(s.getTitulo() + "Avalliação: " + s.getAvaliacao()));
    }
    ...
    private void buscarSeriePorGenero() {
        System.out.println("Digite o gênero da série para busca");
